...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/rancher-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rancher-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add rancher-cli
# for installing globally
pixi global install rancher-cli
```
...
It is possible to list all of the versions of `rancher-cli` available on your platform:
...
```
pixi search rancher-cli --channel conda-forge
```
